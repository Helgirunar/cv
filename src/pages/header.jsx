...
const Header = ({darkMode, toggleDarkMode}) => {
  return (
		<div id="header" style={{backgroundColor: '#2465B4', height: '8vh', width: '100%'}}>
			<div className="centerContainer" style={{height: '7.5vh', margin: 'auto', display: 'flex', position: 'relative'}}>
